...
async function generarReceta() {
  ...
  var urlEntrada = `https://script.google.com/macros/s/AKfycbychlasJA98rYEcVeJR5WSjMWsUH65VFy9qnF01OmDKI6yrMe9nK0zXvKuiIGiwOEO5/exec?id_entrada=${idEntrada}`;

  var idMascota = parametros['id_mascota'];
  var urlMascota = `https://script.google.com/macros/s/AKfycbzfiX4ab6I1Zeev1BDeeIUiCPVRc23yc84bgNPomH8VOUeopcKw5D1WDN3wuQz7IsCE/exec?id_entrada=${idMascota}`;
