...
async function generarReceta() {
  ...
  var urlEntrada = `https://script.google.com/macros/s/AKfycbxsmk-e5zz2wKiYPIAgICwStZgsaRe37RVuCxv9zeLBbgabM6Zq6CgUdfj52-hfVkLMvQ/exec?id_entrada=${idEntrada}`;

  var idMascota = parametros['id_mascota'];
  var urlMascota = `https://script.google.com/macros/s/AKfycbzINoctF73clcYnx9coOqxh8LoMVtdpIN0DEA1jvNMJ6rvviv8IBWSJUvKDKv9Cs1VO4Q/exec?id_entrada=${idMascota}`;
