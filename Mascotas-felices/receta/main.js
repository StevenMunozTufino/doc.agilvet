...
async function generarReceta() {
  ...
  var urlEntrada = `https://script.google.com/macros/s/AKfycbxnnwlx4s7CQvcSTabZGDt4XokSgB8Stwgwp91HKYYX8eEfkrQPOEypw2CRZpr4aQ6K/exec?id_entrada=${idEntrada}`;

  var idMascota = parametros['id_mascota'];
  var urlMascota = `https://script.google.com/macros/s/AKfycbyoMxHdPQc8siptYxDMQq88WAEpGpdU2ZguQ1GTq8Y3Wab69C4Kj8mPFCoys18Ozl1P/exec?id_entrada=${idMascota}`;
